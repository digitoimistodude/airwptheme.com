 ...
 */
define( 'AIR_LIGHT_VERSION', '6.9.5' );
...
$theme_settings = [
   ...
   * Theme textdomain
   */
  'textdomain' => 'airwptheme',

  /**
   * Menu locations
   */
  'menu_locations' => [
      'primary' => __( 'Primary Menu', 'airwptheme' ),
  ],
   ...
   * https://github.com/digitoimistodude/airwptheme#custom-taxonomies
   */
    'taxonomies' => [
  /**
  'your-taxonomy' => [
 ...
 *
 * See the instructions:
 * https://github.com/digitoimistodude/airwptheme#custom-post-types
 */
