...
(function ($) {
  ...
  (function () {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === airwptheme_screenReaderText.expand_toggle
          ? airwptheme_screenReaderText.collapse_toggle
          : airwptheme_screenReaderText.expand_toggle,
      );

      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === airwptheme_screenReaderText.expand_toggle
          ? airwptheme_screenReaderText.collapse_toggle
          : airwptheme_screenReaderText.expand_toggle,
      );
  ...
  $('.menu-item a, .dropdown button').on('keyup', function () {
    if ($('.dropdown').find(':focus').length !== 0) {
      ...
      if (event.keyCode === 27) {
        ...
        // jscs:enable
        screenReaderSpan.text(airwptheme_screenReaderText.expand);
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(airwptheme_screenReaderText.expand);
      ...
      screenReaderSpanNext.text(airwptheme_screenReaderText.expand);
    }
  });
  ...
  // TODO: Rather fix the issue: https://github.com/digitoimistodude/airwptheme/issues/26
  // $(() => {
  //   if (window.innerWidth < responsivenav) {
  ...
  //     dropdownItem.attr('aria-label', airwptheme_screenReaderText.collapse);
  //     screenReaderSpan.text(airwptheme_screenReaderText.collapse);
  //   }
  // });

  // Add default dropdown-toggle label
  $('.dropdown-toggle').each(function () {
    $(this).attr('aria-label', `${airwptheme_screenReaderText.expand_for} ${$(this).prev().text()}`);
  });
  ...
  siteHeaderMenu.find('.dropdown-toggle').click(function (e) {
    if (enterPressed || window.innerWidth < responsivenav) {
      ...
      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === `${airwptheme_screenReaderText.collapse_for} ${$(this).prev().text()}`
          ? `${airwptheme_screenReaderText.expand_for} ${$(this).prev().text()}`
          : `${airwptheme_screenReaderText.collapse_for} ${$(this).prev().text()}`,
      );
    }
  });
