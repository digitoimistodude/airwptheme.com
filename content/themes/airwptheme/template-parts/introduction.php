...
<section class="block block-introduction has-light-bg">
  <div class="container">
    ...
    <div class="col">
      ...
      <div class="col">
        <h3>
          <?php include get_theme_file_path( '/svg/sass.svg' ); ?>
          Modern CSS with PostCSS and SCSS without any bloat
        </h3>
        <p>Forget Bootstrap, Bulma, Foundation and Tailwind. CSS is not hard. Air-light has only the necessary elements like typography, forms and buttons, nothing excess. Create your own SCSS framework with Air-light!</p>
      </div>
